	...
	public void keyPressed (KeyEvent e)
	{
		switch (e.getKeyCode())
		{
			...
			case FIRE_P1:
				...
				break;
			case THRUSTER_P2:
				if (player2 != null && !player2IsAI) facade.setThrusterActive(player2, true);
				break;
			case LEFT_P2:
				if (player2 != null && !player2IsAI) player2_angle = Math.PI / 20;
				break;
			case RIGHT_P2:
				if (player2 != null && !player2IsAI) player2_angle = -Math.PI / 20;
				break;
			case FIRE_P2:
				if (player2 != null && !player2IsAI) player2_fire = true;
				break;
		}
	}
	...
	public void keyReleased (KeyEvent e)
	{
		switch (e.getKeyCode())
		{
			...
			case RIGHT_P1:
				...
				break;
			case THRUSTER_P2:
				if (player2 != null && !player2IsAI) facade.setThrusterActive(player2, false);
				break;
			case LEFT_P2:
				if (player2 != null && !player2IsAI) player2_angle = 0;
				break;
			case RIGHT_P2:
				if (player2 != null && !player2IsAI) player2_angle = 0;
				break;
