...
public class Processor
{
	...
	{
		if (args.length == 0) new Processor().processInteractive();
		else if (args.length == 1) new Processor().processFile(args[0]);
		else System.err.println("usage: java Processor [file-name]");
	}
