...
public class AsteroidsParserMyListener <E, S, T> implements AsteroidsParserListener
{
	...
	{
		if (!canHaveAsFactory(factory)) throw new IllegalArgumentException("bad factory");
	...
	private S StatementOfAction (AsteroidsParserParser.ActionContext action)
	{
		...
		if (action.SKIP() != null) { return (factory.createSkip(line, column)); }
		if (action.FIRE() != null) { return (factory.createFire(line, column)); }
		if (action.THRUSTON() != null) { return (factory.createEnableThruster(line, column)); }
		if (action.THRUSTOFF() != null) { return (factory.createDisableThruster(line, column)); }
		if (action.TURN() != null)
		{
	...
	private S StatementOfCtrl (AsteroidsParserParser.CtrlContext ctrl)
	{
		...
		if (ctrl.ifthenelse() != null) { return (StatementOfIfthenelse(ctrl.ifthenelse())); }
		if (ctrl.whiledo() != null) { return (StatementOfWhiledo(ctrl.whiledo())); }
		if (ctrl.foreach() != null) { return (StatementOfForeach(ctrl.foreach())); }
	...
	{
		if (naconst == null) return null;
		int line = naconst.getStart().getLine();
		int column = naconst.getStart().getCharPositionInLine();

		if (naconst.FALSE() != null) { return (factory.createBooleanLiteral(line, column, false)); }
		if (naconst.TRUE() != null) { return (factory.createBooleanLiteral(line, column, true)); }
		if (naconst.SELF() != null) { return (factory.createSelf(line, column)); }
		if (naconst.NULL() != null) { return (factory.createNull(line, column)); }
	...
	{
		if (op == null || e1 == null) return null;
		int line = e1.getStart().getLine();
		int column = e1.getStart().getCharPositionInLine();
		if (op.GT() != null) { return factory.createGreaterThan(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.LT() != null) { return factory.createLessThan(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.SUB() != null) { return factory.createSubtraction(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.NEQ() != null) { return factory.createInequality(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.GEQ() != null) { return factory.createGreaterThanOrEqualTo(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.EQ() != null) { return (factory.createEquality(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
		if (op.DIV() != null) { return factory.createDivision(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2)); }
		if (op.MUL() != null) { return (factory.createMul(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
		if (op.OR() != null) { return (factory.createOr(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
		if (op.AND() != null) { return (factory.createAnd(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
		if (op.LEQ() != null) { return (factory.createLessThanOrEqualTo(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
		if (op.ADD() != null) { return (factory.createAdd(line, column, ExpressionOfExpr(e1), ExpressionOfExpr(e2))); }
	...
	private E ExpressionOfUnop (AsteroidsParserParser.UnopContext op)
	{
		...
		if (op.GETRADIUS() != null) { return (factory.createGetRadius(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.GETY() != null) { return (factory.createGetY(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.GETX() != null) { return (factory.createGetX(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.GETVY() != null) { return (factory.createGetVY(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.GETVX() != null) { return (factory.createGetVX(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.NOT() != null) { return (factory.createNot(line, column, ExpressionOfExpr(op.expr()))); }
		if (op.SQRT() != null) { return factory.createSqrt(line, column, ExpressionOfExpr(op.expr())); }
		if (op.SIN() != null) { return factory.createSin(line, column, (ExpressionOfExpr(op.expr()))); }
		if (op.COS() != null) { return factory.createCos(line, column, (ExpressionOfExpr(op.expr()))); }
	...
	{
		if (statement == null) { return factory.createSequence(0, 0, Collections.<S> emptyList()); }
		return statement;
	}
